            ...
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #98c0dd;">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php   #admin =1      # Different Menu for different Userrole
                     $_SESSION["user_role"] = 3; #simulation without DB
                    
                 #   $_SESSION["user_role"] = user_role; #sollte mit DB funktionieren
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" style="background-color: #c2d3df;" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="#">Create Newspost</a>
                            ...
                            <a class="dropdown-item" href="#">User activation</a>
                            <a class="dropdown-item" href="#">List of all users</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" style="background-color: #c2d3df;" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="./u.php">Edit User Data</a>
                            <a class="dropdown-item" href="./create_ticket"> Create Ticket</a>
